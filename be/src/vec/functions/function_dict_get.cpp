...
public:
    ...
    Status execute_impl(FunctionContext* context, Block& block, const ColumnNumbers& arguments,
        ...
        return Status::InternalError(
                "just test  dictionary_id {}, version_id {}, return type {}, dict_name {}",
                dict_state->dictionary_id, dict_state->version_id, attribute_type->get_name(),
                block.get_by_position(arguments[0]).column->get_data_at(0).to_string());
    }
};
