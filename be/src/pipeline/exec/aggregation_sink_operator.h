...
protected:
    ...
    void _emplace_into_hash_table(vectorized::AggregateDataPtr* places,
                                  vectorized::ColumnRawPtrs& key_columns, uint32_t num_rows);
    void _emplace_into_hash_table_for_simple_count(vectorized::ColumnRawPtrs& key_columns,
                                                   uint32_t num_rows);
    void _find_and_increment_simple_count(vectorized::ColumnRawPtrs& key_columns,
                                          uint32_t num_rows);
