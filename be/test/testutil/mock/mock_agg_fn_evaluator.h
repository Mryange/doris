...
public:
    ...
    Status prepare(RuntimeState* state, const RowDescriptor& desc,
                   ...
                   const SlotDescriptor* output_slot_desc) override {
        return Status::OK();
    }

    AggFnEvaluator* clone(RuntimeState* state, ObjectPool* pool) override {
        return create_mock_agg_fn_evaluator(*pool, _is_merge, _without_key);
    }
};
